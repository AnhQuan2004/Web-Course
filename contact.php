    ...
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-md-center">
      <div class="col-12 col-lg-6">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            ...
            <p class="lead fs-2 text-secondary mb-5">We're always on the lookout to work with new clients. If you're interested in working with us, please get in touch in one of the following ways.</p>
            <div class="d-flex mb-5">
              ...
              <div>
                <h4 class="mb-3 fs-2">Address</h4>
                <address class="mb-0 text-secondary">19 Đ. Nguyễn Hữu Thọ, Tân Hưng, Quận 7, Thành phố Hồ Chí Minh, Việt Nam</address>
              </div>
            </div>
            <div class="row mb-5">
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-5 mb-sm-0">
                  ...
                  <div>
                    <h4 class="mb-3 fs-2">Phone</h4>
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="tel:+15057922430">(+84) 7777-56135</a>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-0">
                  ...
                  <div>
                    <h4 class="mb-3 fs-2">E-Mail</h4>
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="mailto:anhquan20041452@gmail.com">anhquan20041452@gmail.com</a>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="d-flex">
              ...
              <div>
                <h4 class="mb-3 fs-2">Opening Hours</h4>
      ...
      <div class="col-12 col-lg-6">
        <div class="bg-white border rounded shadow-sm overflow-hidden">
          ...
          <form action="#!">
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5 fs-2">
              <div class="col-12">
